...
public class MockResponse {
     ...
     */
    public static Observable<String> generateJson(long id, int delay, int itemSize, int numItems) throws IOException, JsonGenerationException {
        return Observable.create((Subscriber<? super String> subscriber) -> {
            Schedulers.computation().schedule((scheduler) -> {
                try {
