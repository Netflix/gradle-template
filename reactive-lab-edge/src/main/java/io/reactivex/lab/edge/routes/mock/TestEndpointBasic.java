 ...
 */
public class TestEndpointBasic {

    final static TestEndpointBasic INSTANCE = new TestEndpointBasic();

    public static TestEndpointBasic getInstance() {
        return INSTANCE;
    }
    
    public Observable<Void> testEndpoint(HttpServerRequest<ByteBuf> request, HttpServerResponse<ByteBuf> response) {
