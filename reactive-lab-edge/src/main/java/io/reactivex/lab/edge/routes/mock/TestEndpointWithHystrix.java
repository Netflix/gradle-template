...
public class TestEndpointWithHystrix {

    final static TestEndpointWithHystrix INSTANCE = new TestEndpointWithHystrix();

    public static TestEndpointWithHystrix getInstance() {
        return INSTANCE;
    }
